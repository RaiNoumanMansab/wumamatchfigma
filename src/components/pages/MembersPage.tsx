...
export const MembersPage: React.FC = () => {
  ...
  return (
    <div className="relative z-10 bg-white min-h-screen pt-28 md:pt-36 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background Glow */}
      <div className="pointer-events-none absolute inset-0 bg-radial-teal opacity-[0.07]" />

      <div className="max-w-7xl mx-auto relative z-10 text-center">
        
        {/* Eyebrow & Headline Title */}
        <div className="max-w-3xl mx-auto mb-10 text-center px-4">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-medium text-brand-charcoal mb-4 leading-tight tracking-tight">
        ...
        {/* Full-width Limited Profiles Gold Warning Banner */}
        <div className="w-full bg-[#D4A853] py-2.5 px-4 mb-10 rounded-lg flex items-center justify-center gap-2 text-[10px] sm:text-[11px] font-sans font-semibold uppercase tracking-wider text-white shadow-sm">
          <span className="inline-flex items-center justify-center w-4 h-4 rounded-full border border-white text-white text-[10px] font-bold">!</span>
          <span>YOU ARE VIEWING LIMITED PROFILES. JOIN WUMA MATCH TO UNLOCK FULL PROFILES & REPORTS.</span>
        </div>

        {/* Filter / Search Bar Container */}
        <div className="max-w-6xl mx-auto bg-white border border-zinc-100 rounded-2xl p-6 shadow-sm mb-12 text-left">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-16"
        >
          {membersList.map((member, idx) => (
            ...
            >
              ...
              <button
                type="button"
                className="w-full mt-4 text-center py-2 rounded-lg border border-brand-teal/20 bg-brand-teal/5 text-brand-teal hover:bg-brand-teal/10 transition-colors duration-300 text-[10px] font-bold tracking-wider uppercase"
              >
                Unlock All Profiles
              </button>
        ...
        <div className="flex flex-col items-center justify-center gap-4 pt-4">
          ...
          <button
            type="button"
            className="inline-flex h-10 items-center justify-center gap-2 border border-brand-teal/30 bg-brand-teal/5 hover:bg-brand-teal/10 text-brand-teal px-6 font-bold text-[10px] tracking-widest uppercase rounded-lg transition-colors duration-300"
          >
