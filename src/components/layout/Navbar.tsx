...
px-2 py-1 transition-colors duration-300 hover:border-[#0F9598]/45"
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex h-10 items-center gap-2 rounded-[10px]  px-3 text-[10px] font-bold uppercase tracking-[0.14em] text-[#1C1B19]/72  transition-all duration-300 hover:border-[#0F9598]/35 hover:bg-white hover:text-[#0F9598]"
